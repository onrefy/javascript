class Node {
    ...
    getNeighbour() {
        ...
        if (this.x < this.parent.xNum - 1) {
            if (this.parent.shape[this.x + 1][this.y])
                if (this.isNodeSameState(this.parent.nodeArray[this.x + 1][this.y]) array.push(this.parent.nodeArray[this.x + 1][this.y]);
                }
            if (this.x > 0)
                if (this.parent.shape[this.x - 1][this.y])
            ...
            if (this.y < this.parent.yNum - 1)
                if (this.parent.shape[this.x][this.y+1])
